...
def generate_vcvs_case(seed: int) -> IR:
    ...
    if famiglia == 0:
        ...
        controllo = (REFERENCE_NODE, "A") if seed % 2 == 0 else ("A", REFERENCE_NODE)
        uscita = (REFERENCE_NODE, "C") if seed % 3 == 0 else ("C", REFERENCE_NODE)
        comps = [
            Component.of("V1", "voltage_source_dc", ("A", REFERENCE_NODE), e, "V_1"),
            Component.of("R1", "resistor", ("A", REFERENCE_NODE), r1, "R_1"),
            Component.of("E1", "voltage_controlled_voltage_source", uscita,
                         mu, "E_1", control_nodes=controllo),
        ...
        comps = [
            ...
            Component.of("E1", "voltage_controlled_voltage_source", ("C", REFERENCE_NODE),
                         mu, "E_1", control_nodes=("A", REFERENCE_NODE)),
            Component.of("Rc", "resistor", ("C", REFERENCE_NODE), rc, "R_c"),
...
def generate_vccs_case(seed: int) -> IR:
    ...
    if famiglia == 0:
        ...
        comps = [
            Component.of("V1", "voltage_source_dc", ("A", REFERENCE_NODE), e, "V_1"),
            Component.of("R1", "resistor", ("A", REFERENCE_NODE), r1, "R_1"),
            Component.of("G1", "voltage_controlled_current_source",
                         (REFERENCE_NODE, "C") if seed % 2 == 0 else ("C", REFERENCE_NODE),
