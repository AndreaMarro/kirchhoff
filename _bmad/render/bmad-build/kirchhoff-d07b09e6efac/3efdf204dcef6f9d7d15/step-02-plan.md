...
6. Token count check (see SCOPE STANDARD). If spec exceeds 1600 tokens:
   ...
   - On **S**: Propose the split — name each secondary goal. For each deferred goal, append one new entry to `/Users/andreamarro/MATJOURNEY/kirchhoff/_bmad-output/implementation-artifacts/deferred-work.md` using this format. Do not modify existing entries or look for duplicates. Rewrite the current spec to cover only the main goal — do not surgically carve sections out; regenerate the spec for the narrowed scope. Continue to checkpoint.
     ```markdown
...
Read fully and follow `/Users/andreamarro/MATJOURNEY/kirchhoff/_bmad/render/bmad-build/kirchhoff-d07b09e6efac/3efdf204dcef6f9d7d15/step-03-implement.md`
