...
Follow `/Users/andreamarro/MATJOURNEY/kirchhoff/_bmad/render/bmad-build/kirchhoff-d07b09e6efac/3efdf204dcef6f9d7d15/sync-sprint-status.md` with `target_status` = `in-progress`.
...
- **defer** — pre-existing issue not caused by this change. Append one new entry to `/Users/andreamarro/MATJOURNEY/kirchhoff/_bmad-output/implementation-artifacts/deferred-work.md` using this format. Do not modify existing entries or look for duplicates.
  ```markdown
...
Write `{spec_file}` using `/Users/andreamarro/MATJOURNEY/kirchhoff/_bmad/render/bmad-build/kirchhoff-d07b09e6efac/3efdf204dcef6f9d7d15/spec-template.md`. Fill only these sections — delete all others:

1. **Frontmatter** — set `title: '{title}'`, `type`, `created`, `status: 'done'`. Add `route: 'one-shot'`.
2. **Title and Intent** — `# {title}` heading and `## Intent` with **Problem** and **Approach** lines. Reuse the summary you already generated for the terminal.
3. **Suggested Review Order** — append after Intent. Build using the same convention as `/Users/andreamarro/MATJOURNEY/kirchhoff/_bmad/render/bmad-build/kirchhoff-d07b09e6efac/3efdf204dcef6f9d7d15/step-05-present.md` § "Generate Suggested Review Order" (spec-file-relative links, concern-based ordering, ultra-concise framing).

Follow `/Users/andreamarro/MATJOURNEY/kirchhoff/_bmad/render/bmad-build/kirchhoff-d07b09e6efac/3efdf204dcef6f9d7d15/sync-sprint-status.md` with `target_status` = `review`.
